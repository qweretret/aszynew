...
public class UserController extends BaseController {
	...
	@LogOperation("移交专业")
	@ApiOperation(value = "移交专业")
//	把id1的所有专业的crer字段改为id2
//	@RequiresPermissions(value = { "000000000025" })
	@GetMapping("/trans")
	public ResponseBean trans(@ApiParam(value = "用户id1") @RequestParam(name = "id1", required = true) String uid1, @ApiParam(value = "用户id2") @RequestParam(name = "id2", required = true) String uid2){

		int i = iSubjectService.updateSubjectByCrer(uid1,uid2);
		if (i==0){
			return ResponseBean.Fail("移交失败，请重试");
		}else {
