	...
	<el-container class="indexPage">
		<el-header class="header">
			...
			<div class="right">
				...
				<setting :menuMode="getMenuMode" :theme="getTheme" :themeColor="getThemeColor" @changeMenuMode="changeMenuMode"
				 @changeTheme="changeTheme" @changeNightMode="changeNightMode"></setting>
