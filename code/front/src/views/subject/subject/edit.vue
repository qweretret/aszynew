    ...
    <div slot="body">
      <el-form class="dataForm" ref="form" :disabled="disabled" :model="formParameter" :inline="true" label-width="80px"
        ...
        <el-row>
          ...
          <el-col :span="6" v-if="formParameter.subtype1">
            <el-form-item label="大类名:">{{ formParameter.subtype1 }}</el-form-item>
          </el-col>
          <el-col :span="8" v-if="formParameter.subtype2">
            <el-form-item label="二级类名:">{{ formParameter.subtype2 }}</el-form-item>
          </el-col>
        ...
        <el-row>
          <el-col :span="24">
            <el-form-item label="学制" prop="year">
              <select-option-dictionary v-model="formParameter.year" dkey="sub_xz" :multiple="false" :stringMode="true">
        ...
        <el-row>
          <el-col :span="24">
            <el-form-item label="生源类型" prop="stutype">
              <select-option-dictionary v-model="formParameter.stutype" dkey="sub_sy" :multiple="true"
        ...
        <el-row>
          <el-col :span="24">
            <el-form-item label="教研室" prop="dcode">
              <el-select v-model="formParameter.dcode" placeholder="请选择">
                <el-option v-for="item in depts" :key="item.code" :label="item.name" :value="item.code">
                </el-option>
              </el-select>
            </el-form-item>
          </el-col>
  ...
  methods: {
    handleChange(value) {
      ...
      if (value && value.length < 4) {
        this.$utils.msg.warning("请选择专业[第四级]");
        this.value = []
      } else {
        //清空
