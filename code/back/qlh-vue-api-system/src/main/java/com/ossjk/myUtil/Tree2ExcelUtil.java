...
public class Tree2ExcelUtil {
    ...
    private static boolean tree2Excel(Map tree, String filePath, Object o, Object o1) {
        return true;
    }
     ...
     * @return
     */
    public static Workbook tree2Excel(Map tree, String lableName, String childrenName) {
        doSame(tree, lableName, childrenName);
        Workbook workbook = procesData(tree);
        return workbook;
    }
     ...
     * @throws IOException
     */
    private static void createExcel(OutputStream outputStream, Map tree) throws IOException {
        // 复制模板到新文件
            Workbook wk = procesData(tree);
            if (wk != null) {
                try {
     ...
     * @return 工作表对象
     */
    private static Workbook procesData(Map tree) {
